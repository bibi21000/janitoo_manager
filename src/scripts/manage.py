...
from janitoo_manager.extensions import db, plugin_manager
from janitoo_manager.utils.populate import (create_test_data, create_welcome_forum,
                                    create_admin_user, create_default_groups,
                                    create_default_settings, insert_mass_data,
                                    update_settings_from_fixture,
                                    create_default_categories,
                                    create_default_forums,
                                    create_default_modules_categories,
                                    create_default_modules, populates_modules
                                    )
...
def install(username=None, password=None, email=None):
    ...
    create_admin_user(username='bibi21000', password='bibi21000', email='bibi21000@gmail.com')

    #print("Creating welcome forum...")
    #create_welcome_forum()

    #~ print("Creating default forums and categories ...")
    #~ create_default_categories()
    #~ create_default_forums()
    #~ create_default_modules_categories()
...
def update(settings=None, force=False):
    ...
    try:
        fixture = import_string(
            "janitoo_manager.fixtures.{}".format(settings)
        )
