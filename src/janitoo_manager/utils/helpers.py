...
def do_topic_action(topics, user, action, reverse):
    ...
    :param reverse: If the action should be done in a reversed way.
                    ...
                    set to ``True``.
    """
    from janitoo_manager.utils.permissions import can_moderate, can_delete_topic
    from janitoo_manager.user.models import User
    from janitoo_manager.forum.models import Post
...
def get_categories_and_forums(query_result, user):
    ...
    The structure looks like this::
        [(<Category 1>,
          [(<Forum 1>, None),
           (<Forum 2>, <janitoo_manager.forum.models.ForumsRead at 0x38fdb50>)]),
         (<Category 2>,
          [(<Forum 3>, None),
          (<Forum 4>, None)])]
   ...
   This will print something like this:
        <Category 1>
            <Forum 1> None
            <Forum 2> <janitoo_manager.forum.models.ForumsRead object at 0x38fdb50>
        <Category 2>
            <Forum 3> None
            <Forum 4> None
