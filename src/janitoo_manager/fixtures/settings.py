# -*- coding: utf-8 -*-
"""
    janitoo_manager.fixtures.settings
    ~~~~~~~~~~~~~~~~~~~~~~~~~
...
fixture = (
    ...
    ('general', {
        ...
        'settings': (
            ...
            ('project_subtitle', {
                'value':        "The module repository for Janitoo",
                'value_type':   "string",
    ...
    ('appearance', {
        ...
        "description": "Change the theme and language for your manager.",
        "settings": (
            ('default_theme', {
                'value':        "bootstrap3",
                'value_type':   "select",
            ...
            ('default_language', {
                ...
                'description':  "Change the default language for your manager."
            }),
        ),
    }),
)
